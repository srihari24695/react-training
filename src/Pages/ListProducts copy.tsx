...
function ListProductsPage() {
    ...
    useTitle("Products"); // using the custom hook to set the title of the page to "List Products". Using custom hook
    ...
    async function fetchProducts(){
        ...
        try{
            ...
            if(!auth.isAuthenticated){
              ...
              const response = await axios.get<Product[]>("http://localhost:9000/secure_products",{headers}); // making the api call with headers
